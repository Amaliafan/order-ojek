...
<head>
    ...
    <style>
      .sidebar {
        background-color: #AEDEFC; /* Warna sidebar */
        color: white;
        height: 100vh;
        position: fixed;
        width: 250px;
      ...
      .notification {
        position: fixed;
        top: 20px; /* Adjust this value as needed to move the notification up or down */
        left: 50%;
        transform: translateX(-50%);
        background-color: #AD88C6; /* Warna hijau */
        color: white;
        padding: 15px;
        border-radius: 5px;
      ...
      <div class="menu_container">
        <div class="menu_items">
          ...
          <ul class="menu_item">
            ...
            <li class="item">
              <a href="user.php" class="link flex" onclick="showSection('user-section')">
