...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO `login`('Username','Email`,'Age`, `Password`) VALUES ('$Username','$Email','$Age',$Password')";
...
<img src="Gojek-Logo-Horizontal.jpg" class="gojek-logo"/>
    <div class="container d-flex justify-content-center align-items-center" style="height: 100vh;">
        <div class="form-container">
            <h3 class="text-center mb-4" style="font-family:'Times New Roman', Times, serif"><b>Sign Up</b></h3>
            <form action="profile.php" method="post" style="min-width:300px;">
                ...
                <div class="d-flex justify-content-between" >
                    <button type="submit" class="btn" name="submit" style="background-color: #7852A9; color: white; padding: 6px 20px;  text-align: center; text-decoration: none; display: inline-block; font-size: 16px; margin-top: 10px; margin-right: 20px; cursor: pointer; border-radius: 25px;">Register</button>
                ...
                <div class="links" style=" margin-left:10vh;">
