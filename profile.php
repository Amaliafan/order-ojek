        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <!-- <td>
                <a href="edit-profile.php?id=<?php echo $row["id"]?>" class="link-dark"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                <a href="delete-profile.php?id=<?php echo $row["id"]?>" class="link-dark"><i class="fa-solid fa-trash fs-5"></i></a>
              </td>
            </tr> -->
          <?php
            $counter++; 
